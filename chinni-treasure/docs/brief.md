...
> **Last validated against codebase:** July 25, 2026 — Tokens, fonts, breakpoints, and component patterns re-validated against current code (`app/styles/variables.css`).
