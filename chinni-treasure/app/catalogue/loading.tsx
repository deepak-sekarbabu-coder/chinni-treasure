    ...
    <>
      <section className="catalogue-hero">
        <div className="catalogue-hero-inner">
          <div className="skeleton-text" style={{ width: "120px", height: "12px", marginBottom: "14px" }} />
          <div className="skeleton-text" style={{ width: "320px", height: "36px", marginBottom: "16px" }} />
      ...
      <section className="catalogue-section">
        <div className="section">
          <div className="section-header">
            ...
            <div className="skeleton-text" style={{ width: "280px", height: "28px", margin: "0 auto 16px" }} />
          </div>
